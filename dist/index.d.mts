...
interface NamespaceDeclaration extends Statement {
    type: 'NamespaceDeclaration';
    name: string;
    body: NamespaceBody;
}
interface NamespaceBody extends ASTNode {
    type: 'NamespaceBody';
    properties: NamespaceProperty[];
}
interface NamespaceProperty extends ASTNode {
...
export { type ASTNode, type ArrayExpression, type AssignmentStatement, type BinaryExpression, type BlockStatement, type CallExpression, type DecoratorStatement, type Expression, type ExpressionStatement, type ForStatement, type FunctionDeclaration, type IdentifierExpression, type IfStatement, type IncrementStatement, Lexer, LexerError, type LiteralExpression, type LoopStatement, type MemberExpression, type NamespaceBody, type NamespaceDeclaration, type NamespaceProperty, type NoopStatement, type Parameter, Parser, ParserError, type Program, type ReturnStatement, type Statement, type Token, TokenType, type UnaryExpression, type VariableDeclaration, type WhileStatement, toSource };
